"""
Django settings for reward_on_perchase project.
...
ROOT_URLCONF = 'reward_on_perchase.urls'
...
WSGI_APPLICATION = 'reward_on_perchase.wsgi.application'
...
# Where collectstatic will copy files in production
...
SWAGGER_SETTINGS = {
    ...
    'USE_SESSION_AUTH': False, # Disable Django session login button
}
